...
class Management:
    def __init__(self, root):
        ...
        self.add_bt = Button(
            ...
            bg=self.color_1,
            fg=self.color_3,
        ).place(x=68, y=40, width=90)
        self.view_bt = Button(
            self.frame_1,
            text="LOG IN",
            font=(self.font_1, 12),
            bd=2,
            command=self.GetContact_View,
            cursor="hand2",
            bg=self.color_1,
            fg=self.color_3,
        ).place(x=188, y=40, width=90)
        self.update_bt = Button(
            self.frame_1,
            text="UPDATE",
            font=(self.font_1, 12),
            bd=2,
            command=self.GetContact_Update,
            cursor="hand2",
            bg=self.color_1,
            fg=self.color_3,
        ).place(x=308, y=40, width=90)
        self.delete_bt = Button(
            self.frame_1,
            text="DELETE",
            font=(self.font_1, 12),
            bd=2,
            command=self.GetContact_Delete,
            cursor="hand2",
            bg=self.color_1,
            fg=self.color_3,
        ).place(x=428, y=40, width=90)
        self.clear_bt = Button(
            self.frame_1,
            text="CLEAR",
            font=(self.font_1, 12),
            bd=2,
    ...
    def GetContact_View(self):
        ...
        self.getInfo = Label(
            ...
            font=(self.font_2, 18, "bold"),
            bg=self.color_2,
        ).place(x=332, y=170)
        self.getInfo_entry = Entry(
            self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3
        )
        self.getInfo_entry.place(x=360, y=220, width=200, height=30)
        self.submit_bt_2 = Button(
            self.frame_2,
            text="Submit",
            font=(self.font_1, 10),
            bd=2,
            command=self.CheckContact_View,
            cursor="hand2",
            bg=self.color_1,
            fg=self.color_3,
        ).place(x=420, y=280, width=80)
    ...
    def GetContact_Update(self):
        ...
        self.submit_bt_2 = Button(
            ...
            font=(self.font_1, 10),
            bd=2,
            command=self.CheckContact_Update,
            cursor="hand2",
            bg=self.color_1,
            fg=self.color_3,
        ).place(x=420, y=280, width=80)
    ...
    def CheckContact_View(self):
        if self.getInfo_entry.get() == "":
            ...
            try:
                ...
                curs.execute(
                    "select * from student_register where contact=%s",
                    self.getInfo_entry.get(),
                )
                row = curs.fetchone()
                if row == None:
                    messagebox.showerror(
    ...
    def Checkdate_View(self):
        if self.getInfo_entry.get() == "":
            ...
            try:
                ...
                curs = connection.cursor()
                curs.execute(
                    "select * from student_register where date=%s",
                    self.getInfo_entry.get(),
                )
                row = curs.fetchone()
                ...
                if row == None:
                    messagebox.showerror(
                        "Error!", "date doesn't exists", parent=self.window
                    )
                else:
                    self.ShowDetails(row)
                    connection.close()
        ...
        if self.getInfo_entry.get() == "":
            ...
            try:
                ...
                if row == None:
                    ...
                    curs.execute(
                        "delete from student_register where contact=%s",
                        self.getInfo_entry.get(),
                    )
                    connection.commit()
    ...
    def GetUpdateDetails(self, row):
        ...
        contact_data = Label(self.frame_2, text=row[8], font=(self.font_1, 10)).place(
            x=100, y=290
        )
        ...
        self.submit_bt_1 = Button(
            ...
            font=(self.font_1, 12),
            bd=2,
            command=partial(self.UpdateDetails, row),
            cursor="hand2",
            bg=self.color_1,
            fg=self.color_3,
        ).place(x=300, y=520, width=100)
    ...
    def ShowDetails(self, row):
        ...
        name_data = Label(self.frame_2, text=row[0], font=(self.font_1, 10)).place(
            x=100, y=50
        )
        ...
        surname_data = Label(self.frame_2, text=row[1], font=(self.font_1, 10)).place(
            x=530, y=50
        )
        ...
        course_data = Label(self.frame_2, text=row[2], font=(self.font_1, 10)).place(
            x=100, y=110
        )

        Course_Package = Label(
            self.frame_2,
            text="Course Package",
            font=(self.font_2, 15, "bold"),
            bg=self.color_2,
        ).place(x=530, y=80)
        Course_Package = Label(self.frame_2, text=row[3], font=(self.font_1, 10)).place(
            x=530, y=110
        )
        ...
        Date_data = Label(self.frame_2, text=row[4], font=(self.font_1, 10)).place(
            x=100, y=170
        )
        ...
        age_data = Label(self.frame_2, text=row[5], font=(self.font_1, 10)).place(
            x=530, y=170
        )
        ...
        gender_data = Label(self.frame_2, text=row[6], font=(self.font_1, 10)).place(
            x=100, y=230
        )

        birth = Label(
            self.frame_2, text="DOB", font=(self.font_2, 15, "bold"), bg=self.color_2
        ).place(x=530, y=200)
        birth_data = Label(self.frame_2, text=row[7], font=(self.font_1, 10)).place(
            x=530, y=230
        )
        ...
        email_data = Label(self.frame_2, text=row[9], font=(self.font_1, 10)).place(
            x=530, y=290
        )
        ...
        Current_Course_data = Label(
            self.frame_2, text=row[10], font=(self.font_1, 10)
        ).place(x=100, y=350)

        Pending_Course = Label(
            self.frame_2,
            text="Pending Course",
            font=(self.font_2, 15, "bold"),
            bg=self.color_2,
        ).place(x=530, y=320)
        Pending_Course_data = Label(
            self.frame_2, text=row[11], font=(self.font_1, 10)
        ).place(x=530, y=350)

        Completed_Course = Label(
            self.frame_2,
            text="Completed Course",
            font=(self.font_2, 15, "bold"),
            bg=self.color_2,
        ).place(x=100, y=380)
        Completed_Course_data = Label(
            self.frame_2, text=row[12], font=(self.font_1, 10)
        ).place(x=100, y=410)
        ...
        Total_Fees_data = Label(
            self.frame_2, text=row[13], font=(self.font_1, 10)
        ).place(x=530, y=410)
        ...
        Paid_Fees_data = Label(
            self.frame_2, text=row[14], font=(self.font_1, 10)
        ).place(x=100, y=470)
        ...
        Balance_Fees_data = Label(
            self.frame_2, text=row[15], font=(self.font_1, 10)
        ).place(x=530, y=470)
    ...
    def UpdateDetails(self, row):
        if (
            self.name_entry.get() == ""
            or self.surname_entry.get() == ""
            or self.course_entry.get() == ""
            or self.Course_Package_entry.get() == ""
            or self.date_entry.get() == ""
            or self.age_entry.get() == ""
            or self.gender_entry.get() == ""
            or self.birth_entry.get() == ""
            or self.email_entry.get() == ""
            or self.Current_Course_entry.get() == ""
            or self.Pending_Course_entry.get() == ""
            or self.Completed_Course_entry.get() == ""
            or self.Total_Fees_entry.get() == ""
            or self.Paid_Fees_entry.get() == ""
            or self.Balance_Fees_entry.get() == ""
        ):
            messagebox.showerror(
            ...
            try:
                ...
                if row == None:
                    messagebox.showerror(
                        "Error!",
                        "The contact number doesn't exists",
                        parent=self.window,
                    )
                else:
                    curs.execute(
                        "update student_register set f_name=%s,l_name=%s, course=%s, course_Package=%s, date=%s, age=%s, gender=%s, birth=%s,email=%s,current_course=%s,pending_course=%s,completed_course=%s,total_fees=%s,paid_fees=%s,balance_fees=%s where contact=%s",
                        (
                            self.name_entry.get(),
        ...
        if (
            ...
            try:
                ...
                if row != None:
                    ...
                    curs.execute(
                        "insert into student_register (f_name,l_name,course,course_package,date,age,gender,birth,contact,email,current_course,pending_course,completed_course,Total_fees,paid_fees,balance_fees)values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                        (
                            self.name_entry.get(),
                            self.surname_entry.get(),
                            self.course_entry.get(),
